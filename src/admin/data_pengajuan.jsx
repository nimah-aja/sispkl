...
const DataPengajuanPKL = () => {
  ...
  const renderSubmissionGroup = (title, type) => {
      ...
      <div className="flex">
        ...
        <main className="flex-1 p-4 sm:p-6 md:p-10 bg-[#641E21] rounded-none md:rounded-l-3xl shadow-inner">
          ...
          <div className="mt-6 space-y-3">
            {/* SECTION 1: MENUNGGU (PENDING) - TETAP SENDIRI */}
            {renderSubmissionGroup('Menunggu Persetujuan', 'submit')}

            {/* SECTION 2: PENGAJUAN TERIMA & TOLAK - DIGABUNG JADI SATU SECTION */}
