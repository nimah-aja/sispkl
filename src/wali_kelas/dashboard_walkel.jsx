...
export default function PKLDashboard() {
  ...
  return (
    <div className="bg-white min-h-screen w-full flex">
      {/* Sidebar */}
      <div className="hidden md:block h-screen bg-[#641E21]">
      ...
      <div className="flex-1 flex flex-col">
        ...
        {/* Dashboard Content - Background sudah putih */}
        <main className="flex-1 p-4 sm:p-6 md:p-10 rounded-none md:rounded-l-3xl bg-white">
                    ...
                    {notifikasiPermasalahan.map((notif) => (
                      <div key={notif.id} className="bg-white rounded-xl p-4 flex items-center gap-4">
                        ...
                        <button
                          ...
                          style={{
                            backgroundColor:
                              notif.status === "Tindak" ? "#BC2424" : "#C9B42C",
                          }}
                        >
                          {notif.status}
                        </button>
