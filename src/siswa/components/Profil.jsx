...
export default function ProfilePage({ user, siswa, onClose, roles = [] }) {
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <div className="mt-4">
                ...
                <p className="text-gray-600">{user.kelas_id}</p>
              </div>
              <div className="mt-4">
                <p className="font-medium">Alamat</p>
                <p className="text-gray-600">{siswa?.alamat || "-"}</p>
              </div>
            </div>
            ...
            <div className="mt-25">
              <div className="mt-4 md:mt-0">
                ...
                <p className="text-gray-600">{siswa?.no_telp || ""}</p>
              </div>
            </div>
          </div>
        </div>
